...
export class SessionRepository {
  async upsertMany(sessions: Prisma.SessionUncheckedCreateInput[]) {
  ...
  async deleteOpenSessions(ticketId: string) {
  ...
  async syncOpenSession(ticketId: string, sessionData: Prisma.SessionUncheckedCreateInput | null) {
