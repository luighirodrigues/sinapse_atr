...
exports.SessionAnalysisModelService = void 0;
const crypto_1 = __importDefault(require("crypto"));
const axios_1 = __importDefault(require("axios"));
const env_1 = require("../config/env");
class SessionAnalysisModelService {
    buildPrompt(input) {
        ...
        const messagesPayload = input.messages.map((m) => {
            const ts = (m.updatedAtExternal ?? m.createdAtExternal ?? m.createdAt);
            return {
                messageId: m.id,
        ...
        const promptHash = crypto_1.default.createHash('sha256').update(prompt, 'utf8').digest('hex');
    ...
    async generateReport(input) {
        ...
        const model = env_1.env.OPENAI_MODEL ?? 'gpt-5-mini';
...
exports.SessionAnalysisModelService = SessionAnalysisModelService;
